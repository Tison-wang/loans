...
/**
 * @description: 基于java8封装的时间处理工具类
 * @author:
 * @time: 2019/12/15 18:34
 */
public final class DateUtil {
    ...
    enum FormatEnum {
        ...
        /**
         * 返回 DateTimeFormatter "yyyyMMdd"的时间格式
         */
        FORMAT_DATA_NO_SYMBOL(DateTimeFormatter.ofPattern(DATE_WITHOUT_SYMBOL_FORMAT)),
    ...
    /**
     * <span color='red'>年月日</span>的时间格式（无符号）
     * <br/>
     * 返回 "yyyyMMdd" 字符串
     */
    public static final String DATE_WITHOUT_SYMBOL_FORMAT = YEAR_FORMAT + MONTH_FORMAT + DAY_FORMAT;
    ...
    /**
     * 获取当前日期（无符号），like 20180827
     */
    public static String dateWithoutSymbol() {
        return localDate().format(FormatEnum.FORMAT_DATA_NO_SYMBOL.value);
    }
